 ...
 */
function master_template_woo_customize_preview_js() {
	wp_enqueue_script( 'master-template-woo-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'master_template_woo_customize_preview_js' );
