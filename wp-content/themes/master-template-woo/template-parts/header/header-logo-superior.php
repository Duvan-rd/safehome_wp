...
<!-------------------------------Logo Superior--------------------------------->
				<!----Static header superior---->
				<div class="bottom-header static-header logo-superior p-2">
					<div class="<?php
						...
						?>">
						<div class="row align-items-center justify-content-center row-logo-superior">
							<div class="col-6 col-md-12 text-center">
								<a href="<?php echo site_url(); ?>"><?php if ($geniorama['opt-logo-select'] == '1') {
									$url_logo_dark = $geniorama['img-logo-dark']['url'];
									echo "<img src='$url_logo_dark' class='img-brand mb-3'>";
								} else {
									$url_logo_light = $geniorama['img-logo-light']['url'];
									echo "<img src='$url_logo_light' class='img-brand mb-3'>";
								} ?>
								</a>
							</div>
							...
							<?php endif; ?>
							<div class="col-12 col-md-11 container-nav-header">
								<nav>
									<?php 
										if (has_nav_menu('menu-1')) {
											wp_nav_menu( array(
												...
												'items_wrap' => '<ul class="nav menu-principal">%3$s</ul>',
												'menu_class' => 'nav-item'
											) );
										}
									?>
											...
											<?php 
												if (has_nav_menu('menu-1')) {
													wp_nav_menu( array(
														'theme_location' => 'menu-1',
														'menu_id'        => 'primary-menu',
														'items_wrap' => '<ul class="nav text-left menu-principal">%3$s</ul>',
														'menu_class' => 'nav-item'
													) );
												}
											?>
